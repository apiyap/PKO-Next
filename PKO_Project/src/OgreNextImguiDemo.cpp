...
namespace Demo
{
    ...
    class OgreNextImGuiGraphicsSystem : public GraphicsSystem
    {
    ...
    public:
        OgreNextImGuiGraphicsSystem( GameState *gameState ) : GraphicsSystem( gameState )
        {
            ...
            //	%APPDATA%/PKO_Prpject/ on Windows
            //	~/.config/PKO_Prpject/ on Linux
            //	macCachePath() + "/PKO_Prpject/" (NSCachesDirectory) on Apple -> Important because
            ...
            //	reset.
            //  Obviously you can replace "PKO_Prpject" by your app's name.
#if OGRE_PLATFORM == OGRE_PLATFORM_WIN32
            mWriteAccessFolder = +"/";
            TCHAR path[MAX_PATH];
...
#    endif
                                         ...
                                         LogicSystem **outLogicSystem )
    {
        ...
        GraphicsSystem *graphicsSystem = new OgreNextImGuiGraphicsSystem( gfxGameState );
